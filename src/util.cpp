...
const char * const BITCOIN_CONF_FILENAME = "davies.conf";
const char * const BITCOIN_PID_FILENAME = "daviesd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Davies";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Davies";
#else
    // Unix
    return pathRet / ".davies";
#endif
#endif
}
