...
#if defined(NDEBUG)
# error "Davies cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Davies Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s DVS additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    // Subsidy is cut in half every 2,000,000 blocks
    nSubsidy >>= halvings;
    return nSubsidy;
}
