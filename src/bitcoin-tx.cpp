...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s davies-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  davies-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded davies transaction") + "\n" +
              "  davies-tx [options] -create [commands]   " + _("Create hex-encoded davies transaction") + "\n" +
              "\n";
