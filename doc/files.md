...
* davies.conf: contains configuration settings for daviesd or davies-qt
* daviesd.pid: stores the process id of daviesd while running
...
* debug.log: contains debug information and general logging generated by daviesd or davies-qt
